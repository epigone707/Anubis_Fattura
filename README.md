...
6. After thread 1 starts, thread 0 loads and invokes a method `apps.com.app.utils.startSocks` with params: (context, [host], [user], [pass], [port]). About how to find the source code of this method, see the [ddfasd](www.baidu.com) section.
